...
import com.sz.enums.MsgSignFlagEnum;
import com.sz.enums.SearchFriendsStatusEnum;
import com.sz.mapper.*;
import com.sz.netty.ChatMsg;
import com.sz.pojo.FriendsRequest;
import com.sz.pojo.MyFriends;
...
import com.sz.utils.QRCodeUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public Users saveUser(Users user) {
        ...
        // honeytree_qrcode:[username]
        qrCodeUtils.createQRCode(qrCodePath, "honeytree_qrcode:" + user.getUsername());
    ...
    @Transactional(propagation = Propagation.REQUIRED)
    @Override
    public void deleteSubscribe(String myUserId, String friendUserId) {
        Example fre = new Example(MyFriends.class);
        Example.Criteria frc = fre.createCriteria();
        frc.andEqualTo("myUserId", myUserId);
        frc.andEqualTo("myFriendUserId", friendUserId);
        myFriendsMapper.deleteByExample(fre);
    }
...
//        }
    ...
    public List<MyFriendsVO> queryMyFans(String userId) {
        List<MyFriendsVO> myFirends = usersMapperCustom.queryMyFans(userId);
        return myFirends;
    }
    ...
    public String saveMsg(ChatMsg chatMsg) {
        com.sz.pojo.ChatMsg msgDB = new com.sz.pojo.ChatMsg();
    ...
    @Transactional(propagation = Propagation.SUPPORTS)
    @Override
    public List<com.sz.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {
        Example chatExample = new Example(com.sz.pojo.ChatMsg.class);
        Example.Criteria chatCriteria = chatExample.createCriteria();
        chatCriteria.andEqualTo("signFlag", 0);
        chatCriteria.andEqualTo("acceptUserId", acceptUserId);

        List<com.sz.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);
